...
for dir in dirs:
    ...
    di['mpi'] = 'undefined'
    dstrt = 0
    if machine == 'theta' or machine == 'vesta':
        dstrt = 1
            ...
            while True:
                ...
                if len(fsplt)>0:
                    ...
                    if fsplt[0]=='[EXPERIMENT]':
                        ...
                        elif fsplt[2]=='[Topology-Aware-CCIO]:':
                            d[ 'optype' ] = 'topology-aware-ccio'
                        elif fsplt[2]=='[Bad-Agg-CCIO]:':
                            d[ 'optype' ] = 'bad-agg-ccio'
